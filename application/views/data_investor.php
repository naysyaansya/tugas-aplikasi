...
<div>
	<h2> Klik dibawah sini untuk menambah data investor </h2>
	<a href="<?php echo base_url() ?>index.php/Welcome/TambahDataInvestor"><button class="btn btn-primary btn-lg"> Tambah Data </button></a>
<br>
<br>
<div class="box-body no-padding">
	<table class="table table-condensed">
		...
		foreach ($data_investor as $tampilkan) {
			...
			echo "<td><a href='EditDataInvestor/$tampilkan->id_investor'><button class='btn btn-primary btn-xs'>Edit</button></a><button class= 'btn-danger btn-xs' type='button' onClick='hapus($tampilkan->id_investor)'>Hapus</button></td>";
			echo "</tr>";
		}
		?>
	</table>
