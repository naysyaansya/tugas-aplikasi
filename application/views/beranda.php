...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assetplugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>Investor</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Naysya Ansya A. U</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li>
          <a href="<?php echo base_url() ?>index.php/Welcome/Data_Asset">
            <i class="fa fa-th"></i> <span>Data Asset</span>
         ...
         <li>
          <a href="<?php echo base_url() ?>index.php/Welcome/Data_Investor">
            <i class="fa fa-th"></i> <span>Data Investor</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span>
          </a>
         ...
         <li>
          <a href="<?php echo base_url() ?>index.php/Welcome/Data_User">
    ...
    <section class="content">
     <?php 
      ...
      switch ($halaman) {
        ...
        $this->load->view('TambahDataAsset');
        break;
        case 'TambahDataInvestor':
        $this->load->view('TambahDataInvestor');
        break;
        case 'TambahDataUser':
        $this->load->view('TambahDataUser');
        break;
        case 'EditDataUser':
        $this->load->view('EditDataUser');
        break;
        case 'EditDataAsset':
        $this->load->view('EditDataAsset');
          break;
          case 'EditDataInvestor':
        $this->load->view('EditDataInvestor');
          break;
          default;
          echo "error";
          break;
